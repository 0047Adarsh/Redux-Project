  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-cente relative">
         ...
         { !position.latitude && !position.longitude && <span className="absolute right-[5px] top-[7px] z-999">  
        ...
        <div className="mb-12 flex gap-5 items-center">
          ...
          />
          <label className="sm:basis-40" htmlFor="priority">Want to yo give your order priority?</label>
        </div>
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          <Button type="primary"  disabled={isSubmitting || isLoadingAddress}>{isSubmitting ? "Submitting Order" : `Order now for ${formatCurrency(totalCartPrice)}`}</Button>
